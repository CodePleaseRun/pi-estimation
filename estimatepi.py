...
RAND_LIST = np.linspace(-1, 1, 10**POINT_PRECISION)


def get_random_points():
    return random.choice(RAND_LIST), random.choice(RAND_LIST)
...
def update_func(frame, sc_list, circle_graph, approx_pi_graph, approx_graph):
    ...
    approx_graph.set_ylim(apgy[-1]-0.25, apgy[-1]+0.25)
